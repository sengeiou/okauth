 ...
 * @since May 16, 2020
 */
public class InvalidAccessTokenException extends OAuth2ErrorException {
     ...
     */
    public InvalidAccessTokenException(OpenPlatform openPlatform, String errorCode, String message) {
